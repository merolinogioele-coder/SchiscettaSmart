...
// Aggiungi l'indicatore "Sta scrivendo..."
function showTypingIndicator() {
  const typingDiv = document.createElement('div');
  typingDiv.classList.add('chatbot-typing');
  typingDiv.id = 'typing-indicator';
  typingDiv.textContent = 'L\'AI sta pensando...';
...
async function sendChatMessage() {
  ...
  try {
    // Richiama la Edge Function di Supabase
    // NOTA: il nome della funzione sarà 'chat-ai'
    ...
    addChatMessage("Ops, sembra esserci un problema di rete.", 'bot');
  }
}
